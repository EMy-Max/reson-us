...
class SuccessDialog extends StatelessWidget {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    RichText(
                      text:
                      TextSpan(style: TextStyle(fontSize: 15.sp, color: Colors.black), children:
                      _buildSubscribedServicesText(subscribedServices)),
                    ),
                    ...
                    ElevatedButton(
                      ...
                      BorderRadius.circular(22.r),), minimumSize:
  ...
  List<TextSpan> _buildSubscribedServicesText(List<String> services) {
    if (services.length == 1) {
      return [
        TextSpan(text: '"${services[0]}"', style:
        const TextStyle(fontWeight:
        FontWeight.w500)),
      ];
    } else if (services.length >= 2) { // Handle two or more services
      return [
        TextSpan(text:
        '"${services[0]}"', style:
        const TextStyle(fontWeight:
      ...
      return []; // Return an empty list if no services are provided
    }
  }
}
